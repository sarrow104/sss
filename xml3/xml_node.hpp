...
#define _XML_NODE_FRIEND_ \
    friend class xml_visitor; \
friend class xml_printer;
...
namespace sss{
    namespace xml3{
        ...
        // sss::xml3::node 可以像 Boost.Spirit 范例 mini_xml，那样，创建吗？
        //
        // struct mini_xml;
        //
        // typedef
        ...
        // };
        //
        // 首先，它定义了一个不完全类型 mini_xml；然后定义了一个特化后的模板类的别名
        // mini_xml_node;
        //
        // 最后，才完成mini_xml具体的定义：
        // struct mini_xml
        ...
        //
        // template<typename T>
        // class T : public sss::can::findbytype<int, T>,
        //           public sss::can::dtree<T>
        // {
        // }
        //
        // 好像不行啊；还是得涉及具体的实现……
        ...
        class node :
            public sss::can::findbytype<int, node>,
            public sss::can::dtree<node>
        {
            _XML_NODE_FRIEND_;

        public:
            typedef sss::can::findbytype<int, node> Base_findtype;
            typedef sss::can::dtree<node> Base_tree;
